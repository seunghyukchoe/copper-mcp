...
# 7,716.  ``"0.11.0"`` and ``"0.12.0"`` are six characters too, so at this cut -- as at the last
# one -- the length **does not move** and only the digest does, which is exactly the separation
# the two constants exist for.
# That the digest move is nothing but the version literal was verified rather than assumed:
# substituting ``0.11.0`` back into the rendered bytes reproduces the previous golden
# ``sha256:8dded9b21f4fc87db382acebf60fe7663c2dee20161cbeb6ce5b9f6bf8c363a4`` at 7,716 bytes
# exactly, and the version literal occurs exactly once in the artifact.
# Pinned at CopperMCP 0.12.0.
...
SCHEMATIC_ARTIFACT_DIGEST = (
    "sha256:9b55b2538c75e2c9dbc42eec43ab1d33ac5f663ac6eff39569aa6ed8026a87b4"
)
