...
- ADR-0129 records the safety model for a live one-undo-commit apply into a running KiCad
...
- Issue #68 moves from "parked" to "designed; live probe predeclared; implementation gated on the
  probe" in the roadmap. Records: B-144, D-240, R-189, SEC-174, ADR-0129.
