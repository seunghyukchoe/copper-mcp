...
| Claim | On the six B-114 candidates probed, removing exactly the Edge.Cuts-curve and `.Cu`-text refusals converts **0/6**; together with the other four boards' recorded pass-two refusals, the ten-board corpus remains **0/10**. The next first refusals are listed above, and the corrected exact reruns for M.2 and Amalthea do not change that finding. |
