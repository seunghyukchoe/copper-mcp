...
| Integrity | Source hashes were unchanged and `committed_board_bytes` is 0. The aggregate artifact is self-digested as `sha256:fce8c2ac33fd5168c1f8a695c197cb9637a0f564fc859e207185cae14f636778` and binds runner digest `sha256:6637e77c108bf24ce5dda0256074347431bc7170a4e8262b877ccfae1b1e790b`. Focused tests cover the three exact masks, whole-class splicing, nested/multilayer refusal, manifest closure and bounds, symlinks, alternate cohorts, source mutation, deterministic identity, redaction, terminal classification, and the pass ceiling. |
