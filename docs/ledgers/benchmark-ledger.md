...
| Records | [D-195](decision-ledger.md), [R-150](risk-register.md), [SEC-144](security-ledger.md), [ADR-0104](../adr/0104-fill-vertex-budget-behind-a-parse.md), [Fill-vertex budget calibration](../research/fill-vertex-budget-calibration-v1.md), `B-105` (issue #63, open at the time of writing), issue #165 |
