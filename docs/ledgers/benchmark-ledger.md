...
| Artifact | [`benchmarks/results/placement/2026-08-12-courtyard-side-oracle-parity.json`](../../benchmarks/results/placement/2026-08-12-courtyard-side-oracle-parity.json), validated against its own self-digest by `scripts/check_ledgers.py`. The runner refuses to emit an artifact if any contradiction appears. |
