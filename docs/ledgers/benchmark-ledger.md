...
| Run ID | `sha256:63a105e210187de1ceb147dfa9107a59866a70d3f2439aa0bac52b0d3ab08659`; deterministic identity `sha256:d8b278ca0a7e2ec755fe5d8ad17376e4a83706f27bd79cd53dde26d6751e23d1`. |
| Date, source and environment | 2026-08-17; clean source `64835f6b0ab0370bc5e19dce617b51fd3dc02d5c`; Apple arm64; Python 3.12.13; no network, KiCad CLI, model, accelerator or board mutation. Absolute timing is one-host environmental evidence. |
...
| Result | All eight executions returned one output digest, `sha256:ef6219e861f5bcd8d18142d1a3d16a2529e4e857a5f713c62c262eb1685d0148`. Unprofiled median/min/max: `41,795,417 / 41,201,750 / 46,787,000 ns`. Instrumented complete read: `133,444,667 ns`; Board IR entry `995,719 ppm`; `parse_sexpr` `685,938 ppm`; tokenization `505,139 ppm`; typed model conversion `303,980 ppm`. Cumulative shares are nested and must not be summed. The prediction passed. |
