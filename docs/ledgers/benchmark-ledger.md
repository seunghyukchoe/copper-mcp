...
| Result | **The one-million gate failed.** One 1,000,000-vertex ring completed in 19.91 s, but ten 100,000-vertex rings took **20.24 s**, beyond the fixed 20-second gate. The selected 500,000 ring completed in **10.15 s** with **110,431,900** incremental traced bytes; the widest recorded 43,889 ring completed in **1.50 s** with **9,713,819** bytes. Both passed. Exact 500,000 is admitted; 500,001 returns `invalid_request` before bounds or hashing; an aliased 11,000,000 aggregate returns `obstacle_check_budget_exceeded` before vertex access. Candidate identity matched on every accepted replay. |
...
| Artifact | [`2026-08-17-layered-fill-island-budget-v1.json`](../../benchmarks/results/routing/2026-08-17-layered-fill-island-budget-v1.json), self-digested run `sha256:a2f14a46b163c080df12aac5ff9244681bebdadd772a4e6790de56de82eb19ec`; benchmark, fixture, adapter, canonicalizer and layered A* hashes are bound and checked by `tests/test_benchmark_layered_fill_island_budget.py`. |
