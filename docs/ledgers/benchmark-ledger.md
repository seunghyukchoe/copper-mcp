...
| Method and safety boundary | Apple arm64, macOS 26.5.2, Python 3.12.13, clean CopperMCP commit `dc095c4d4735f9cdd8bf1ddb03fb229fb665ffed`. The predeclared aggregate fingerprint fixes membership and bytes before any gate runs. Each private source is captured once through the production workspace-confined, symlink-refusing, byte-bounded reader. Conversion uses those immutable bytes. The route branch invokes the production native-geometry-identity gate. The placement branch invokes the production source-bound preview pipeline over those same captured bytes and revision, then the source-preserving in-memory renderer. Branch failures are isolated. Apply, live IPC, live apply, KiCad DRC, filesystem mutation and editor launch are disabled or absent. Every source digest is re-read through the same bounded boundary after measurement; all 18 remain unchanged. |
...
| Artifact | [`2026-08-24-frozen-appliability-census-v1.json`](../../benchmarks/results/capability/2026-08-24-frozen-appliability-census-v1.json), canonical run ID `sha256:f4fbd13cbacac0ada096a007957cfbb93e792795495057b8fab6502a7cbe5459`, runner digest `sha256:fc646b0ac783c67864edc3505de0670ca2cc838fcaf6d354b0df4f3f39153bbe`. Focused tests bind both digests, exact aggregate verdicts, the clean commit and the disclosure exclusions. |
