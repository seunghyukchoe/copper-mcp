...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-184` | `D-185` |
| [Risk register](risk-register.md) | `R-` | `R-139` | `R-140` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-135` | `SEC-136` |
