...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-175` | `D-176` |
| [Risk register](risk-register.md) | `R-` | `R-132` | `R-133` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-131` | `SEC-132` |
