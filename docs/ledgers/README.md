...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-268` | `D-269` |
| [Risk register](risk-register.md) | `R-` | `R-205` | `R-206` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-200` | `SEC-201` |
