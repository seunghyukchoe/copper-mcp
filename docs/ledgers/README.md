...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-214` | `D-215` |
| [Risk register](risk-register.md) | `R-` | `R-166` | `R-167` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-155` | `SEC-156` |
