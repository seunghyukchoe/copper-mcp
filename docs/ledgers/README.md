...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-270` | `D-271` |
| [Risk register](risk-register.md) | `R-` | `R-207` | `R-208` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-202` | `SEC-203` |
