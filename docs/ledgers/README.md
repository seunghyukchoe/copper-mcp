...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-232` | `D-233` |
| [Risk register](risk-register.md) | `R-` | `R-183` | `R-184` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-168` | `SEC-169` |
