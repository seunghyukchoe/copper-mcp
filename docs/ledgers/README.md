...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-215` | `D-216` |
| [Risk register](risk-register.md) | `R-` | `R-167` | `R-168` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-156` | `SEC-157` |
