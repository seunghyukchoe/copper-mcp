...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-272` | `D-273` |
| [Risk register](risk-register.md) | `R-` | `R-209` | `R-210` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-204` | `SEC-205` |
