...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-267` | `D-268` |
| [Risk register](risk-register.md) | `R-` | `R-204` | `R-205` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-199` | `SEC-200` |
