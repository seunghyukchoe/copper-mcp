...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-256` | `D-257` |
| [Risk register](risk-register.md) | `R-` | `R-198` | `R-199` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-187` | `SEC-188` |
