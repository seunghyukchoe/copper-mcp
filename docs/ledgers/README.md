...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-263` | `D-264` |
| [Risk register](risk-register.md) | `R-` | `R-201` | `R-202` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-195` | `SEC-196` |
