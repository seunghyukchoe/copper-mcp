...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-235` | `D-236` |
| [Risk register](risk-register.md) | `R-` | `R-185` | `R-186` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-171` | `SEC-172` |
