...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-262` | `D-263` |
| [Risk register](risk-register.md) | `R-` | `R-200` | `R-201` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-194` | `SEC-195` |
