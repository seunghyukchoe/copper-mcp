...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-217` | `D-218` |
| [Risk register](risk-register.md) | `R-` | `R-168` | `R-169` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-157` | `SEC-158` |
