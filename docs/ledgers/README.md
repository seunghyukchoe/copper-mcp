...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-266` | `D-267` |
| [Risk register](risk-register.md) | `R-` | `R-203` | `R-204` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-198` | `SEC-199` |
