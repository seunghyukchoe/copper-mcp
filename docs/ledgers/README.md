...
|---|---|---|---|
| [Decision ledger](decision-ledger.md) | `D-` | `D-271` | `D-272` |
| [Risk register](risk-register.md) | `R-` | `R-208` | `R-209` |
| [Security review ledger](security-ledger.md) | `SEC-` | `SEC-203` | `SEC-204` |
