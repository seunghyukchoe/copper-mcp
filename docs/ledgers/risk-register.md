...
| R-004 | Dependency or GitHub Action compromise affects contributors/releases. | Medium | High | Minimal dependencies, Dependabot, audit, CodeQL, attestations, future SHA pinning. | Open / release |
