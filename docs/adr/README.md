...
| [0070](0070-conservative-arc-track-envelopes.md) | Model foreign arc tracks as conservative integer envelopes rather than refusing the board | Accepted |
...
- [ADR-0070: Conservative integer envelopes for foreign arc tracks](0070-conservative-arc-track-envelopes.md)
