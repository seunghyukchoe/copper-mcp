...
| [0075](0075-incremental-retention-and-bounded-ripup-window.md) | Reconstruct the congestion ledger incrementally and bound rip-up by a spatial window | Accepted |
...
- [ADR-0075: Reconstruct the congestion ledger incrementally and bound rip-up by a spatial window](0075-incremental-retention-and-bounded-ripup-window.md)
