...
1. Copy [`template.md`](template.md) and assign the next unused number — currently **0115**.
...
One hundred and fourteen numbers allocated, one hundred and nine records, no duplicates — and
...
#172's — so neither is a gap, and all of 0100 through 0114 are real records in the index above.
